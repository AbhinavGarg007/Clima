...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "74761103b24561f06960a2bf8ec46555";
    ...
    private void getWeatherforCurrentLocation() {
        ...
        //using another way to get fast location
        ...
        requestParams.put("lat",myLatitude);
        requestParams.put("lon",myLongitude);
